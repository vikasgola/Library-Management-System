...
setup(name='Library Management System',
      ...
      python_requires = '>=3.6',
      packages=['Library_Management_System', 'Library_Management_System/helper','Library_Management_System/gui','Library_Management_System/database', 'Library_Management_System/data'],
